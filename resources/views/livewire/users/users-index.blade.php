   ...
   <div class="p-3">
       ...
       <div class="overflow-x-auto mt-4 rounded-lg shadow dark:shadow-gray-800">
           <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
               <thead class="text-xs uppercase bg-gray-500/20 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-center">
               <tr>
               ...
               <tbody>
                @forelse ($users as $user)                    
                    <tr class="odd:bg-white odd:dark:bg-gray-800 even:bg-gray-50 even:dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 text-center" wire:key="user-{{ $user->id }}">
