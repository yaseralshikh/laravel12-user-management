<div>
    <flux:modal name="create-school" class="md:w-[600px]">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">إضافة مدرسة جديدة</flux:heading>
                <flux:text class="mt-2">أدخل تفاصيل المدرسة الجديدة</flux:text>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <flux:checkbox wire:model="is_complex" label="المدرسة ضمن مجمع مدارس" class="col-span-2" />
            </div>
