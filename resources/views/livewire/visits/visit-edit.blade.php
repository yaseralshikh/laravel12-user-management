<flux:modal name="edit-visit" class="min-w-[28rem]">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">تعديل الزيارة</flux:heading>
        </div>

        <div class="space-y-4">
            {{-- School --}}
            <div>
                <flux:label for="edit_school_id">المدرسة <span class="text-red-500">*</span></flux:label>
                <flux:select
                    id="edit_school_id"
            ...
            {{-- User --}}
            <div>
                <flux:label for="edit_user_id">المستخدم <span class="text-red-500">*</span></flux:label>
                <flux:select
                    id="edit_user_id"
                    wire:model="user_id"
            ...
            {{-- Academic Year --}}
            <div>
                <flux:label for="edit_academic_year_id">السنة الدراسية <span class="text-red-500">*</span></flux:label>
                <flux:select
            ...
            {{-- Program Cycle --}}
            <div>
                <flux:label for="edit_program_cycle_id">برنامج الدورة</flux:label>
                <flux:select
                    id="edit_program_cycle_id"
            ...
            {{-- Visit Date --}}
            <div>
                <flux:label for="edit_visit_date">تاريخ الزيارة <span class="text-red-500">*</span></flux:label>
                <flux:input
                    id="edit_visit_date"
                    type="date"
            ...
            {{-- Visit Type --}}
            <div>
                <flux:label for="edit_visit_type">نوع الزيارة <span class="text-red-500">*</span></flux:label>
                <flux:select
                    id="edit_visit_type"
            ...
            {{-- Objective --}}
            <div>
                <flux:label for="edit_objective">الهدف</flux:label>
                <flux:textarea
                    id="edit_objective"
            ...
            {{-- Notes --}}
            <div>
                <flux:label for="edit_notes">الملاحظات</flux:label>
                <flux:textarea
                    id="edit_notes"
                    wire:model="notes"
            ...
            {{-- Recommendations --}}
            <div>
                <flux:label for="edit_recommendations">التوصيات</flux:label>
                <flux:textarea
        ...
        <div class="flex gap-2">
            ...
            <flux:button type="submit" variant="primary" wire:click="save">حفظ التغييرات</flux:button>
        </div>
    </div>
</flux:modal>
