<div>
    <flux:modal name="edit-program-cycle" class="md:w-full md:max-w-lg">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">تعديل دورة البرنامج</flux:heading>
                <flux:text class="mt-2">عدّل تفاصيل دورة البرنامج.</flux:text>
            </div>
            ...
            <div class="flex">
                <flux:spacer />
                <flux:button type="submit" variant="primary" wire:click="updateProgramCycle">تحديث</flux:button>
            </div>
        </div>
    </flux:modal>
</div>
