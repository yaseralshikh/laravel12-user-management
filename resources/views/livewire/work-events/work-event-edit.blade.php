<flux:modal name="edit-work-event" class="max-w-2xl">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">تعديل الحدث</flux:heading>
        </div>
        ...
        <form wire:submit="update" class="space-y-6">
            ...
            <div class="flex gap-2 border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <flux:button type="submit" variant="primary">تحديث الحدث</flux:button>
            </div>
        </form>
    </div>
</flux:modal>
