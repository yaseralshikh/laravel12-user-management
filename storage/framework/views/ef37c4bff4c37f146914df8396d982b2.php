...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::modal.index','data' => ['name' => 'view-work-event','class' => 'max-w-2xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'view-work-event','class' => 'max-w-2xl']); ?>
    <div class="space-y-6">
        <div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'lg']); ?>تفاصيل الحدث <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workEvent): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                
                <div class="space-y-4">
                    <div>
                        <span class="text-sm font-semibold text-gray-600 dark:text-gray-400">العنوان</span>
                        <p class="mt-1 text-gray-900 dark:text-gray-100"><?php echo e($workEvent['title']); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1">
                            <span class="px-2 py-1 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded text-sm">
                                <?php echo e($workEvent['event_type']); ?>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 dark:text-gray-100">
                            <?php echo e(\Carbon\Carbon::parse($workEvent['event_date'])->format('Y-m-d')); ?>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 dark:text-gray-100"><?php echo e($workEvent['user']['name']); ?></p>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="mt-1 text-gray-900 dark:text-gray-100"><?php echo e($workEvent['location'] ?? '-'); ?></p>
                    </div>

                    <div>
                        <span class="text-sm font-semibold text-gray-600 dark:text-gray-400">السنة الدراسية</span>
                        <p class="mt-1 text-gray-900 dark:text-gray-100"><?php echo e($workEvent['academic_year']['name']); ?></p>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workEvent['program_cycle']): ?>
                        <div>
                            <span class="text-sm font-semibold text-gray-600 dark:text-gray-400">برنامج الدورة</span>
                            <p class="mt-1 text-gray-900 dark:text-gray-100">
                                <?php echo e($workEvent['program_cycle']['program']['name']); ?> - <?php echo e($workEvent['program_cycle']['term']); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($workEvent['description']): ?>
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    <span class="text-sm font-semibold text-gray-600 dark:text-gray-400">الوصف</span>
                    <p class="mt-2 text-gray-900 dark:text-gray-100 whitespace-pre-wrap"><?php echo e($workEvent['description']); ?></p>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\projects\laravel12-user-management\resources\views/livewire/work-events/work-event-view.blade.php ENDPATH**/ ?>